#ifndef CLIENT_SERVER_BERKELEY_UDPIP_SOCKETS_COMMON_SOCKET_H_
#define CLIENT_SERVER_BERKELEY_UDPIP_SOCKETS_COMMON_SOCKET_H_
...
#endif  // CLIENT_SERVER_BERKELEY_SOCKETS_UDPIP_COMMON_SOCKET_H_
