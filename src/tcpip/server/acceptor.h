#ifndef CLIENT_SERVER_BERKELEY_SOCKETS_TCPIP_SERVER_ACCEPTOR_H
#define CLIENT_SERVER_BERKELEY_SOCKETS_TCPIP_SERVER_ACCEPTOR_H
...
#endif  // CLIENT_SERVER_BERKELEY_SOCKETS_TCPIP_SERVER_ACCEPTOR_H